            ...
            sideTitles: SideTitles(
              ...
              getTitlesWidget: (value, meta) {
                return Text(
                  ...
                  style: theme.textTheme.bodySmall?.copyWith(
                    fontSize: 9, // Giảm font size để tiết kiệm không gian
                    fontWeight: FontWeight.w600,
                  ),
                  textAlign: TextAlign.right, // Align về phía phải
                );
              },
              reservedSize: 65, // Giảm từ 70 xuống 65
              interval: _getMaxY() / 4,
            ),
          ),
