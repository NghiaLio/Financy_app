...
class _AccountMoneyScreenState extends State<AccountMoneyScreen> {
  ...
  List<MoneySource> get moneySources => [
    MoneySource(
      ...
      description: AppLocalizations.of(context)!.physicalCash,
    ),
    MoneySource(
      id: '2',
      name: 'MoMo Wallet',
      ...
      description: AppLocalizations.of(context)!.digitalWallet,
    ),
    MoneySource(
      id: '3',
      name: 'Vietcombank',
      ...
      description: AppLocalizations.of(context)!.bankingAccount,
    ),
    MoneySource(
      id: '4',
      name: 'ZaloPay',
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return _MoneySourceTile(
                          ...
                          onEdit: () => _showEditSourceDialog(source, index),
              ...
              ElevatedButton(
                onPressed: () {
                  setState(() {
                    ...
                    moneySources[index].description =
